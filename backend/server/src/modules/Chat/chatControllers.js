    ...
    try {
        ...
        if(containedWord){
            ...
            // if(containedWord === "Restaurant:"){
                ...
                if(FindRestaurant[0]){
                    CmdChatText = `System prompt: Found the restaurant ${FindRestaurant[0].ResName},With a rating of ${FindRestaurant[0].rating*5} stars.Explain the restaurant breifly and Tell the user that we have that restaurant and you'll navigate them soon. Also mention that they can leave a review.`
